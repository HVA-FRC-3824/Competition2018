...
//        chooser.addDefault("AutonomousCommand", new AutonomousCommand());
    ...
    public void showInformationOnDashboard()
    {
        ...
        SmartDashboard.putNumber("Chassis Right Motor", chassis.getChassisRightMotorPercent());
        SmartDashboard.putNumber("Chassis Left Motor", chassis.getChassisLeftMotorPercent());
        ...
        SmartDashboard.putNumber("Elevator Control Mode", Robot.elevator.getMotorControlMode().value);
