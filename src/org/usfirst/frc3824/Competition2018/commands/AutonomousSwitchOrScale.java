...
public class AutonomousSwitchOrScale extends CommandGroup
{
    ...
    public AutonomousSwitchOrScale(String startingPosition, String oneTwoCube, String target) {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
        ...
        if (gameData.length() >= 2)
        {
            ...
            if (startingPosition.contains("Right") && gameData.charAt(0) == 'R' && target.contains("Switch"))
            {
            ...
            else if (startingPosition.contains("Left") && gameData.charAt(0) == 'L'  && target.contains("Switch"))
            {
...
//                addSequential(new AutonomousCrossAutoLine());
    ...
    public void placeSwitch(String startingPosition, SecondCubePos secondCube)
    {
        ...
        initializeIntakeAndElevator(Constants.IntakeAngleShootAngle, Constants.ElevatorSwitchPosition);

        // Drive forward to Switch
        addSequential(new ChassisDriveDistance(Constants.AutoSwitchOrScaleDriveSwitchDistance, 
        ...
        addSequential(new ChassisDriveRange(Constants.AutoSwitchOrScaleToSwitchDistance, 
                                            Constants.UltrasonicDriveDistancePower,
    ...
    public void placeScale(double angle, boolean isRightStart)
    {
        ...
        addSequential(new ChassisDriveDistance(Constants.AutoSwitchOrScaleDriveScaleDistance, 
                                               Constants.AutoSwitchOrScaleDriveScalePower, driftAngle));
    ...
    public void placeOppositeScale(String startingSide)
    {
        ...
        addSequential(new ChassisDriveRange(36.0, 0.4, 0.6, angleFirstTurn));

        // Turn to drive up the field
        addSequential(new ChassisTurnAngle(0.0, 0.0), Constants.ChassisTurnTimeOutTime);

        // Set the elevator height, intake angle, and intake wheels to hold cube
        initializeIntakeAndElevator(Constants.IntakeAngleShootAngle, Constants.ElevatorScalePositionTheirs);
    ...
    public boolean getCornerCubeSwitch(boolean isRightStart)
    {
        ...
        addSequential(new ChassisDriveDistance(Constants.AutoSwitchOrScaleToNextCube1Distance, 
                                               Constants.AutoSwitchOrScaleToNextCube1Power, angle));
        ...
        addSequential(new ChassisDriveRange(Constants.AutoSwitchOrScaleToCubeDistance, 0.4,
                      Constants.AutoSwitchOrScaleToCubePower, angle));
        ...
        // Set intake in position to receive new cube
        addParallel(new IntakeRotate(Constants.IntakeAngleShootAngle));
