...
public class AutonomousPlaceSwitchCenter extends CommandGroup
{
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
        ...
        double angle    = 45.0; // Assume placing on the right switch
        double distance = 0.0;
        ...
        if (gameData.length() > 0)
        {
            ...
            addSequential(new ChassisDriveDistance(Constants.AutoCenterSwitchFromWall, 0.4, 0.0));
            ...
            addSequential(new ChassisDriveDistance(Constants.AutoCenterSwitchDiagonal + distance, 0.6, angle));
