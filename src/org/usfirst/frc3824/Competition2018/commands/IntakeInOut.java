...
public class IntakeInOut extends Command
{
    ...
    public IntakeInOut(boolean directionIn, double RPM)
    {
...
//        double timeD = 0.05;
//        
//        if (m_directionIn == true)
//        {
//            if (timer.get() < timeA)
//                Robot.intake.setWheelVoltageRight(true, m_RPM);
//            else if (timer.get() < timeA + timeB)
//                Robot.intake.setWheelVoltageRight(true, 0);   
//            else if (timer.get() < timeA + timeB + timeC)
//                Robot.intake.setWheelVoltageRight(false, 0.2);   
//            else if (timer.get() < timeA + timeB + timeC + timeD)
//                Robot.intake.setWheelVoltageRight(true, 0);   
//            else            
//                timer.reset();
//        }
        ...
        // Determine if either the Intake In or Intake Out button is pressed
