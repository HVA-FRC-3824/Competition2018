...
public class RobotMap
{
    ...
    public static AnalogInput chassisultrasonic;
    public static WPI_TalonSRX intakeRight;
    public static WPI_TalonSRX intakeLeft;
    public static WPI_TalonSRX intakeAngle;
    public static WPI_TalonSRX elevatorLiftMaster;
    public static WPI_TalonSRX elevatorLiftSlave;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS

    /*********************************************************************
     * Method to initialize the robot components
     *********************************************************************/
	public static void init()
	{
        ...
        chassisLeftDriveEncoder.setDistancePerPulse(0.00454545);
        ...
        chassisRightDriveEncoder.setDistancePerPulse(0.00454545);
        ...
        chassisultrasonic = new AnalogInput(1);
        LiveWindow.addSensor("Chassis", "ultrasonic", chassisultrasonic);
        ...
        intakeAngle = new WPI_TalonSRX(3);
        
        
        elevatorLiftMaster = new WPI_TalonSRX(4);
        
        
        elevatorLiftSlave = new WPI_TalonSRX(5);
