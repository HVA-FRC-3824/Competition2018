...
public class OI
{
    ...
    public OI()
    {
        ...
        eleavatorScale.whenPressed(new ElevatorUpDownPosition(2000));
        elevatorSwitch = new JoystickButton(opJoystick, 4);
        elevatorSwitch.whenPressed(new ElevatorUpDownPosition(1000));
        elevatorChute = new JoystickButton(opJoystick, 3);
        elevatorChute.whenPressed(new ElevatorUpDownPosition(500));
