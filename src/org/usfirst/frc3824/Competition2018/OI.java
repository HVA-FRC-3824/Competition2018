...
//    public JoystickButton changeScaleHeightDown;
    ...
    public OI()
    {
        ...
        elevatorSwitch.whenPressed(new ElevatorUpDownPosition(-2500));
        ...
        elevatorDown.whenPressed(new ElevatorUpDownPosition(23500));
        ...
        intakeWheelIn.whenPressed(new IntakeInOut(true, 0.4));
        ...
        SmartDashboard.putData("IntakeRotateStep: stepUp", new IntakeRotateStep(500));
        SmartDashboard.putData("IntakeRotateStep: stepDown", new IntakeRotateStep(-500));
        SmartDashboard.putData("IntakeRotateCube", new IntakeRotateCube());
        SmartDashboard.putData("IntakeRotateReset", new IntakeRotateReset());
