...
public class Chassis extends Subsystem {
    ...
    private final SpeedController speedR1 = RobotMap.chassisSpeedR1;
    private final SpeedController speedR2 = RobotMap.chassisSpeedR2;
    private final SpeedControllerGroup rightDrive = RobotMap.chassisRightDrive;
    private final SpeedController speedL1 = RobotMap.chassisSpeedL1;
    private final SpeedController speedL2 = RobotMap.chassisSpeedL2;
	...
	/**
	 * reset the distance traveled to 0.0.  getDistanceTraveled is based on the last reset
	 */
	...
	/**
	 * drive the robot "straight".  This function does not currently include a gyro based PID to 
	 * 	actually keep it driving straight.
	 * 
